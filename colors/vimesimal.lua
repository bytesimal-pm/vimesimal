...
local groups = {
  ...
  Delimiter = { fg = p.gray },
  PreProc = { fg = p.preproc, bold = true },
  Include = { fg = p.preproc, bold = true },
  Define = { fg = p.preproc, bold = true },
  Macro = { fg = p.preproc, bold = true },
  PreCondit = { fg = p.preproc, bold = true },
  Type = { fg = p.type },
  ...
  ["@constant.macro"] = { fg = p.preproc, bold = true },
  ["@module"] = { fg = p.type },
  ["@label"] = { link = "Label" },
  ["@string"] = { link = "String" },
  ...
  ["@keyword.directive"] = { fg = p.preproc, bold = true },
  ["@keyword.directive.define"] = { fg = p.preproc, bold = true },
  ["@keyword.import"] = { fg = p.preproc, bold = true },
  ...
  -- LSP
  ["@lsp.type.macro"] = { fg = p.preproc, bold = true },
